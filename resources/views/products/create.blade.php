                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_main_product" name="is_main_product" value="1" {{ old('is_main_product') ? 'checked' : '' }}>
                                    </div>
                                </div>
                                <div class="col-sm-7">
                                    <select class="form-select" name="main_product_id">
                                        ...
                                        @foreach($mainProducts as $mp)
                                            <option value="{{ $mp->id }}" {{ old('main_product_id') == $mp->id ? 'selected' : '' }}>{{ $mp->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
